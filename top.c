...
/* .lflg anomolies:
     ...
     ------  -----------    -------  ------  -----  -----  ----------------------   -------- */
   { "AaAa", "   PID",      " %5u",     -1,    -1, SF(PID2), "Process Id",           L_NONE   },
...
static void before (char *me)
{
...

   {
      ...
      Fieldstab[P_PID2].fmts = pid_fmt;
      Fieldstab[P_PID2].head = "        PID" + 10 - pid_digits;
...
//       if (!VIZCHKc) break;
      ...
      {  static struct {
            ...
            { "Memory", 'M', P_MEM, }, { "Numerical", 'N', P_PID2, },
